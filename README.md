Задание 1. Создание нового React-приложения:
Откройте терминал и создайте новое React-приложение с помощью Vite 2. Установка React Router Dom:
Установите последнюю версию React Router Dom, введя команду в терминале:
npm install react-router-dom 3. Создание страниц приложения:
...
`UserProfile.js`: создайте функциональный компонент, который будет отображать информацию о конкретном пользователе. Используйте параметры маршрута для получения идентификатора пользователя из URL. 4. Настройка маршрутизации:
...
Создайте маршруты для каждой страницы, используя `Routes` и `Route`. 5. Добавление фиктивных данных и маршрутизации:
В файле `Users.js`:
